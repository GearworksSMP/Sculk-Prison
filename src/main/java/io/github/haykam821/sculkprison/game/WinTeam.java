...
public enum WinTeam {
	PLAYERS(Text.literal("text.sculkprison.win.players").formatted(Formatting.YELLOW)),
	WARDEN(Text.literal("text.sculkprison.win.warden").formatted(Formatting.DARK_AQUA));
